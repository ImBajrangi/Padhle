  ...
  return (
    <div className="notfound-viewport">
      <div className="notfound-content-wrap">
        <div className="notfound-bg-digits">404</div>
        <h2 className="notfound-message">Nothing to see here.</h2>
        
        <button className="notfound-home-btn" onClick={onGoHome}>
          Go Home
        </button>

        <div className="notfound-walker-wrap">
          <div className="walker-loader">
              ...
              <svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="144.10576" height="144.91623" viewBox="0 0 144.10576 144.91623">
                <g transform="translate(-164.41679,-112.94712)">
                  <g strokeMiterlimit={10}>
                    ...
                    <path d="M216.22445,188.06994c0,0 1.02834,11.73245 -3.62335,21.11235c-4.65169,9.3799 -13.06183,10.03776 -13.06183,10.03776c0,0 7.0703,-3.03121 10.89231,-10.7381c4.34839,-8.76831 5.79288,-20.41201 5.79288,-20.41201z" fill="none" stroke="var(--walker-stroke-sec)" strokeWidth={3} strokeLinecap="round" />
                  </g>
                </g>
              </svg>
            </div>
